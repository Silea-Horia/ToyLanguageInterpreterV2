...
public class Fork implements Statement {
    ...
    public ProgramState execute(ProgramState state) throws StmtException {
        ...
        return new ProgramState(newStack, state.getSymTable().deepCopy(), state.getOut(), this.newProgram, state.getFileTable(), state.getSemaphoreTable(), state.getLatchTable(), state.getLockTable(), state.getHeap());
    }
